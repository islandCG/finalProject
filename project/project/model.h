...
Mesh Model::processMesh(aiMesh* mesh, const aiScene* scene) {
	...
	if (mesh->mMaterialIndex >= 0) {
		...
		//cout << material->GetTextureCount(aiTextureType_HEIGHT) << endl;
		//cout << material->GetTextureCount(aiTextureType_NORMALS) << endl;
...
unsigned int TextureFromFile(const char *path, const string &directory, bool gamma) {
	...
	string str = filename.substr(filename.find_last_of('.') + 1);
